...
public class DayOffService {
    ...
    public DayOff addDayOff(DayOffDTO dayOffDTO) {
        ...
        if (!((calStart.get(Calendar.HOUR_OF_DAY) == 8 || calStart.get(Calendar.HOUR_OF_DAY) == 12) && (calEnd.get(Calendar.HOUR_OF_DAY) == 12 || calEnd.get(Calendar.HOUR_OF_DAY) == 18))) {
            throw new BadRequestException("Wrong time format. Time off must begin at 8:xx or 12:xx and Time off must end at 12:xx or 18:xx");
        }
        ...
        email.setText(CommonMethods.formatContentEmail(titles, content,
                Constants.POINT_PAGE_MANAGEMENT_DAY_OFF,
